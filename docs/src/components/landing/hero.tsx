...
export const Hero = ({ lang, translation }: HeroProps) => (
  <div>
    ...
    <div className="relative before:absolute before:top-0 before:h-px before:w-full before:bg-border after:absolute after:-bottom-1 after:h-px after:w-full after:bg-border">
